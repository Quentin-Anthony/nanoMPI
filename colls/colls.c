...
int MPI_Allgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
  ...
  return MPI_Allgatherv_basic(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
...
int MPI_Allreduce(const void *sendbuf, void *recvbuf, int count,
  ...
  if (msg_size < 16384) {
    status =
        MPI_Allreduce_reduce_bcast(sendbuf, recvbuf, count, datatype, op, comm);
  } else {
...
int MPI_Alltoall(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                 void *recvbuf, int recvcount, MPI_Datatype recvtype,
                 MPI_Comm comm) {
  return MPI_Alltoall_basic(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                            recvtype, comm);
}
...
int MPI_Gather(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
               ...
               MPI_Comm comm) {
  return MPI_Gather_basic(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                          recvtype, root, comm);
}
...
int MPI_Reduce_scatter(const void *sendbuf, void *recvbuf,
                       ...
                       MPI_Comm comm) {
  return MPI_Reduce_scatter_basic(sendbuf, recvbuf, recvcounts, datatype, op,
                                  comm);
}
...
int MPI_Scatter(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
                void *recvbuf, int recvcount, MPI_Datatype recvtype, int root,
                MPI_Comm comm) {
  return MPI_Scatter_basic(sendbuf, sendcount, sendtype, recvbuf, recvcount,
                           recvtype, root, comm);
}
